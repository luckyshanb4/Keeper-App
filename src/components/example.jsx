	...
	render() {
		return (
			<div>{/* React components must have a wrapper node/element */}
				...
				<div className="form-group">
					<button onClick={!isClicked && concole.log("clicked!")} type="button" className="btn btn-primary" disabled={false}>Submit</button> {/* Some form attributes use an expression to set true or false: they include disabled, required, checked and readOnly */}
				</div>
